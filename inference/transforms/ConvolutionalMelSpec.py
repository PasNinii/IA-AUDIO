...
class ConvolutionalMelSpec(MelSpectrogram):
    def __init__(self, hop_length=None,
        ...
        super(ConvolutionalMelSpec, self).__init__(sample_rate=sample_rate,
                                                    n_fft=fft_length,
    ...
    def forward(self, x, lengths=None):
        ...
        if (torch.rand(1)[0] <= self.prob and self.training and self.random_crop):
